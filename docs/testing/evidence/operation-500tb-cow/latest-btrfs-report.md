...
| Operation | Time |
|---|---:|
| Non-compressible sample write + sync | 24360 ms |
| Read-only baseline snapshot | 225 ms |
| Writable thin clone | 135 ms |
| Clone-only 4 MiB mutation + sync | 519 ms |
| Rewind from baseline | 791 ms |
